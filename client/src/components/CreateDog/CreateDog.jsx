...
import image from '../../image/doghome1.jpg'
...
const CreateDog = () => {
    ...
    return (
        ...
        <div className={styles.creteraza}>
        <img src={image} alt='doghome1'/>
        </div>
        ...
        >
        <div className={styles.requerido}>
            Campo requerido *
        </div>
        ...
        <input
              ...
              value={input.weight}
              onChange={e => handleChange(e)}
              className={errors.weight ? styles.inputIncorrect : styles.inputs}
              placeholder='00 - 00'>
        </input>
        <div className={styles.errors}>
